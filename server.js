(function () {
    ...
    app.post('/dialogflow', (request, response) => {
        ...
        function welcome(agent) {
            agent.add(`Welcome Thunder beast.`);
            welcome2();
        }
        
        function welcome2() {
            agent.add(`What can i doo for you.`);
        }

        function fallback(agent) {
            agent.add(`I didn't understandtest`);
            agent.add(`I'm sorry, can you try again?test`);
        }

        function testWebhook(agent) {
            agent.add(`This went right inside Webhooktest`);
        }
